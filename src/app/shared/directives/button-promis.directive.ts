...
import { AfterContentInit, Directive, ElementRef, HostListener, Inject, Input, OnDestroy, PLATFORM_ID } from '@angular/core';
import { isPlatformBrowser } from '@angular/common';

@Directive({
  selector: '[ButtonPromise]',
  standalone: true
})

export class ButtonPromiseDirective implements OnDestroy, AfterContentInit {
  ...
  private _fakePromiseResolve: () => any;
  ...
  constructor(
    ...
    this.cfg = {
      spinnerTpl: '<span class="loader"><i class="fa-regular fa-spinner fa-spin"></i></span>',
      disableBtn: true,
